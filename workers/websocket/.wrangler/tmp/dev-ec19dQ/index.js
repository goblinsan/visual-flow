...
// .wrangler/tmp/bundle-Ffct30/checked-fetch.js
...
var fromCamelCase = /* @__PURE__ */ __name((s, separator) => trimLeft(s.replace(fromCamelCaseRegex, (match2) => `${separator}${toLowerCase(match2)}`)), "fromCamelCase");
...
var match = /* @__PURE__ */ __name((state) => new PatternMatcher(
  /** @type {any} */
  state
), "match");
var _random = (
...
// src/index.ts
var CanvasRoom = class {
  static {
    __name(this, "CanvasRoom");
  }
  constructor(state) {
    this.state = state;
...
var src_default = {
  async fetch(request, env) {
    ...
    const canvasId = url.pathname.slice(1);
    if (!canvasId) {
      return new Response("Canvas ID required", { status: 400 });
    }
    const id2 = env.CANVAS_ROOM.idFromName(canvasId);
    const room = env.CANVAS_ROOM.get(id2);
...
// .wrangler/tmp/bundle-Ffct30/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-Ffct30/middleware-loader.entry.ts
