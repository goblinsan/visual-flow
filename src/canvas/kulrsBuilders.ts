  ...
  return {
    root: {
      ...
      children: [
        ...
        { id: 'nav-logo', type: 'text', text: 'Brand', variant: 'h2', fontSize: 20, position: { x: 32, y: 18 }, size: { width: 120, height: 28 }, color: textOn(nav), fontFamily: hf },
        { id: 'nav-link1', type: 'text', text: 'Home', variant: 'body', fontSize: 14, position: { x: 200, y: 22 }, size: { width: 60, height: 20 }, color: textOn(nav), fontFamily: bf },
        { id: 'nav-link2', type: 'text', text: 'Features', variant: 'body', fontSize: 14, position: { x: 280, y: 22 }, size: { width: 70, height: 20 }, color: textOn(nav), fontFamily: bf },
        { id: 'nav-link3', type: 'text', text: 'Pricing', variant: 'body', fontSize: 14, position: { x: 370, y: 22 }, size: { width: 60, height: 20 }, color: textOn(nav), fontFamily: bf },
        ...
        { id: 'hero-title', type: 'text', text: 'Welcome to Our Platform', variant: 'h1', fontSize: 40, position: { x: 120, y: 160 }, size: { width: 600, height: 52 }, color: t.isDark ? lighten(hero, 0.3) : darken(hero, 0.3), fontFamily: hf },
        { id: 'hero-subtitle', type: 'text', text: 'Build amazing things with our tools', variant: 'body', fontSize: 18, position: { x: 120, y: 228 }, size: { width: 480, height: 28 }, color: t.isDark ? lighten(hero, 0.5) : hero, fontFamily: bf },
        { id: 'hero-cta', type: 'rect', position: { x: 120, y: 278 }, size: { width: 160, height: 48 }, fill: accent, stroke: undefined, strokeWidth: 0, radius: 8, opacity: 1 },
        { id: 'hero-cta-text', type: 'text', text: 'Get Started', variant: 'body', fontSize: 15, position: { x: 136, y: 290 }, size: { width: 130, height: 24 }, color: textOn(accent), fontFamily: bf },
        { id: 'content', type: 'rect', position: { x: 120, y: 504 }, size: { width: 1200, height: 360 }, fill: t.cardBg, stroke: t.border, strokeWidth: 1, radius: 12, opacity: 1 },
        { id: 'content-title', type: 'text', text: 'Featured Content', variant: 'h2', fontSize: 22, position: { x: 152, y: 532 }, size: { width: 300, height: 30 }, color: t.textPrimary, fontFamily: hf },
      ] as LayoutNode[],
    },
  };
}
  ...
  return {
    root: {
      ...
      children: [
        ...
        { id: 'sidebar-logo', type: 'text', text: 'Dashboard', variant: 'h2', fontSize: 18, position: { x: 24, y: 24 }, size: { width: 180, height: 28 }, color: textOn(sidebar), fontFamily: hf },
        ...
        { id: 'nav-text1', type: 'text', text: 'Overview', variant: 'body', fontSize: 14, position: { x: 24, y: 90 }, size: { width: 150, height: 20 }, color: textOn(sidebar), fontFamily: bf },
        { id: 'nav-text2', type: 'text', text: 'Analytics', variant: 'body', fontSize: 14, position: { x: 24, y: 140 }, size: { width: 150, height: 20 }, color: lighten(textOn(sidebar), 0.3), fontFamily: bf },
        { id: 'nav-text3', type: 'text', text: 'Settings', variant: 'body', fontSize: 14, position: { x: 24, y: 180 }, size: { width: 150, height: 20 }, color: lighten(textOn(sidebar), 0.3), fontFamily: bf },
        ...
        { id: 'header-title', type: 'text', text: 'Overview', variant: 'h2', fontSize: 18, position: { x: 272, y: 18 }, size: { width: 200, height: 28 }, color: t.textPrimary, fontFamily: hf },
  ...
  return {
    root: {
      ...
      children: [
        ...
        { id: 'status-time', type: 'text', text: '9:41', variant: 'body', fontSize: 13, position: { x: 220, y: 52 }, size: { width: 50, height: 20 }, color: textOn(primary), fontFamily: bf },
        ...
        { id: 'nav-title', type: 'text', text: 'Home', variant: 'h2', fontSize: 20, position: { x: 340, y: 100 }, size: { width: 100, height: 24 }, color: textOn(primary), fontFamily: hf },
  ...
  return {
    root: {
      ...
      children: [
        ...
        { id: 'logo', type: 'text', text: 'Dashboard', variant: 'h2', fontSize: 18, position: { x: 32, y: 18 }, size: { width: 200, height: 28 }, color: textOn(primary), fontFamily: hf },
        ...[0, 1, 2, 3].map((i) => {
          const x = 40 + i * 340;
          const cc = safe(c, i);
          return [
            ...
            { id: `stat-${i}-val`, type: 'text' as const, text: `${(i + 1) * 1234}`, variant: 'h1' as const, fontSize: 32, position: { x: x + 24, y: 114 }, size: { width: 200, height: 40 }, color: cc, fontFamily: hf },
            { id: `stat-${i}-lbl`, type: 'text' as const, text: ['Users', 'Revenue', 'Orders', 'Growth'][i], variant: 'body' as const, fontSize: 13, position: { x: x + 24, y: 162 }, size: { width: 200, height: 20 }, color: t.textSecondary, fontFamily: bf },
          ];
        }).flat(),
        ...
        { id: 'chart-title', type: 'text', text: 'Performance Overview', variant: 'h2', fontSize: 16, position: { x: 72, y: 292 }, size: { width: 300, height: 28 }, color: t.textPrimary, fontFamily: hf },
        ...[0, 1, 2, 3, 4, 5, 6].map((i) => ({
        ...
        { id: 'side-title', type: 'text', text: 'Recent Activity', variant: 'h2', fontSize: 16, position: { x: 992, y: 292 }, size: { width: 300, height: 28 }, color: t.textPrimary, fontFamily: hf },
        ...[0, 1, 2, 3, 4].map((i) => ({
  ...
  return {
    root: {
      ...
      children: [
        ...
        { id: 'nav-brand', type: 'text', text: 'Brand', variant: 'h2', fontSize: 22, position: { x: 60, y: 22 }, size: { width: 120, height: 28 }, color: primary, fontFamily: hf },
        ...
        { id: 'nav-cta-text', type: 'text', text: 'Sign Up', variant: 'body', fontSize: 14, position: { x: 1300, y: 26 }, size: { width: 90, height: 20 }, color: textOn(primary), fontFamily: bf },
        ...
        { id: 'hero-p', type: 'text', text: 'The all-in-one platform for creators, designers,\nand developers to bring their ideas to life.', variant: 'body', fontSize: 18, position: { x: 200, y: 280 }, size: { width: 500, height: 56 }, color: t.textSecondary, fontFamily: bf },
        { id: 'hero-btn1', type: 'rect', position: { x: 200, y: 354 }, size: { width: 160, height: 48 }, fill: primary, stroke: undefined, strokeWidth: 0, radius: 10, opacity: 1 },
        { id: 'hero-btn1-t', type: 'text', text: 'Get Started', variant: 'body', fontSize: 15, position: { x: 218, y: 366 }, size: { width: 130, height: 24 }, color: textOn(primary), fontFamily: bf },
        { id: 'hero-btn2', type: 'rect', position: { x: 380, y: 354 }, size: { width: 160, height: 48 }, fill: 'transparent', stroke: primary, strokeWidth: 2, radius: 10, opacity: 1 },
        { id: 'hero-btn2-t', type: 'text', text: 'Learn More', variant: 'body', fontSize: 15, position: { x: 398, y: 366 }, size: { width: 130, height: 24 }, color: t.isDark ? lighten(primary, 0.4) : primary, fontFamily: bf },
        { id: 'features-title', type: 'text', text: 'Features', variant: 'h1', fontSize: 28, position: { x: 580, y: 600 }, size: { width: 280, height: 40 }, color: t.textPrimary, fontFamily: hf },
        ...[0, 1, 2].map((i) => {
          const x = 120 + i * 420;
          const cc = safe(c, i);
          return [
            ...
            { id: `feat-${i}-h`, type: 'text' as const, text: ['Fast', 'Secure', 'Scalable'][i], variant: 'h2' as const, fontSize: 18, position: { x: x + 24, y: 770 }, size: { width: 300, height: 28 }, color: t.textPrimary, fontFamily: hf },
            { id: `feat-${i}-p`, type: 'text' as const, text: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.', variant: 'body' as const, fontSize: 14, position: { x: x + 24, y: 806 }, size: { width: 332, height: 44 }, color: t.textSecondary, fontFamily: bf },
          ];
        }).flat(),
        { id: 'cta-bg', type: 'rect', position: { x: 60, y: 980 }, size: { width: 1320, height: 180 }, fill: primary, stroke: undefined, strokeWidth: 0, radius: 20, opacity: 1 },
        { id: 'cta-h', type: 'text', text: 'Ready to get started?', variant: 'h1', fontSize: 28, position: { x: 200, y: 1018 }, size: { width: 700, height: 40 }, color: textOn(primary), fontFamily: hf },
        { id: 'cta-btn', type: 'rect', position: { x: 1000, y: 1010 }, size: { width: 200, height: 48 }, fill: textOn(primary), stroke: undefined, strokeWidth: 0, radius: 10, opacity: 1 },
        { id: 'cta-btn-t', type: 'text', text: 'Start Free Trial', variant: 'body', fontSize: 15, position: { x: 1014, y: 1022 }, size: { width: 174, height: 24 }, color: primary, fontFamily: bf },
      ] as LayoutNode[],
    },
  };
}
