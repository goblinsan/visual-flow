...
export const THEME_TAXONOMY: ThemeEntry[] = [
  ...
  },
  {
    ...
    description: 'Confident contrast, clean grids, and trustworthy detail.',
    icon: 'fa-solid fa-chart-pie',
    mood: 'technical',
    secondaryMoods: ['minimal'],
    suggestedColors: ['#0B3A5B', '#1F8A70', '#EAF4F4', '#F2B705'],
    suggestedFonts: ['Outfit', 'Inter'],
    industries: ['finance', 'technology'],
  },
  {
    id: 'editorial-minimal',
    name: 'Editorial Minimal',
    description: 'Refined typography and calm neutral color architecture.',
    icon: 'fa-solid fa-newspaper',
    mood: 'minimal',
    secondaryMoods: ['elegant'],
    suggestedColors: ['#111827', '#6B7280', '#F9FAFB', '#D1D5DB'],
    suggestedFonts: ['DM Sans', 'Inter'],
    industries: ['fashion', 'other', 'technology'],
  },
  {
    id: 'ops-control',
    name: 'Ops Control',
    description: 'High-signal dashboard language with clear status contrast.',
    icon: 'fa-solid fa-gauge-high',
    mood: 'technical',
    secondaryMoods: ['bold'],
    suggestedColors: ['#111827', '#2563EB', '#D1FAE5', '#EF4444'],
    suggestedFonts: ['Inter', 'IBM Plex Sans'],
    industries: ['technology', 'finance', 'health'],
  },
  {
    id: 'immersive-dark',
    name: 'Immersive Dark',
    description: 'Moody dark surfaces with vibrant luminous accents.',
    icon: 'fa-solid fa-moon',
    mood: 'bold',
    secondaryMoods: ['technical'],
    suggestedColors: ['#0F172A', '#1E293B', '#22D3EE', '#F43F5E'],
    suggestedFonts: ['Outfit', 'Inter'],
    industries: ['gaming', 'technology', 'other'],
  },
];
